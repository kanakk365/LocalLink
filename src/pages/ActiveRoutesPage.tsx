  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-24 pb-12">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-900">Active Delivery Routes</h1>
          <p className="text-gray-600 mt-1">View scheduled and ongoing delivery routes</p>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden h-full">
              ...
              {selectedRoute ? (
                <div>
                  ...
                  <div className="p-4">
                    <h3 className="font-medium text-gray-900 mb-2">Delivery Stops</h3>
                    
                    <div className="ml-2 relative border-l-2 border-gray-200 pl-6 py-2">
                      {mockRoutes.find(r => r.id === selectedRoute)?.destinations.map((dest, idx) => (
                        <div key={idx} className="mb-6 relative">
                          <div className="absolute -left-[2.15rem] w-4 h-4 rounded-full border-2 border-gray-200 bg-white"></div>
                      ...
                      <div className="absolute -left-[2.15rem] bottom-0 w-4 h-4 rounded-full bg-green-500"></div>
                    </div>
                  </div>
                </div>
              ) : (
