...
const CreateRoute: React.FC = () => {
  ...
  return (
    <div className="bg-white">
      <p className="text-gray-700 mb-6">Share your journey with others and help deliver items along your route.</p>
        ...
        <div className="space-y-6">
          ...
          {showPreview && formData.startLocation && formData.endLocation && (
            <div className="mt-4">
              ...
              <RouteMap startLocation={formData.startLocation} endLocation={formData.endLocation} />
            </div>
          )}
        </div>
        ...
        <div className="mt-8 flex space-x-4">
          {!showPreview && (
            <button
              ...
              className="flex-1 bg-gray-200 text-gray-800 font-medium py-3 px-4 rounded-lg hover:bg-gray-300 transition duration-200"
            >
              Preview Route
            </button>
          )}
          <button
            type="submit"
            className={`${showPreview ? 'w-full' : 'flex-1'} bg-black text-white font-medium py-3 px-4 rounded-lg hover:bg-gray-800 transition duration-200`}
          >
            Create Route
          </button>
        </div>
